...
async function storedSecrets() {
  ...
  return {
    ...
    [keys.telegramBotToken]: await getSecret(keys.telegramBotToken),
    [keys.telegramChatId]: await getSecret(keys.telegramChatId),
...
async function effectiveSecrets() {
  ...
  return {
    ...
    [keys.telegramBotToken]: await get(keys.telegramBotToken, 'TELEGRAM_BOT_TOKEN'),
    [keys.telegramChatId]: await get(keys.telegramChatId, 'TELEGRAM_CHAT_ID'),
