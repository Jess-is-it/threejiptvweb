...
export function secretKeys() {
  return {
    ...
    cloudflareTurnstileSecret: 'cloudflareTurnstileSecret',
    xuiAdminBaseUrl: 'xuiAdminBaseUrl',
    xuiAdminAccessCode: 'xuiAdminAccessCode',
    xuiAdminApiKey: 'xuiAdminApiKey',
    xuiAdminUsername: 'xuiAdminUsername',
    xuiAdminPassword: 'xuiAdminPassword',
  };
}
