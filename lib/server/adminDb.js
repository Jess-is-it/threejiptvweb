...
import { defaultNotificationSettings, defaultNotificationState } from '../notificationDefaults';
...
export async function getAdminDb() {
  ...
  db.notificationSettings =
    db.notificationSettings && typeof db.notificationSettings === 'object'
      ? deepMerge(defaultDb().notificationSettings, db.notificationSettings)
      : defaultDb().notificationSettings;
  db.notificationState =
    db.notificationState && typeof db.notificationState === 'object'
      ? deepMerge(defaultDb().notificationState, db.notificationState)
      : defaultDb().notificationState;
