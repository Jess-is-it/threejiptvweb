...
function mergeNotificationState(current, patch) {
  ...
  const currentServiceStatus = isObject(currentTelegram.serviceStatus)
    ? currentTelegram.serviceStatus
    : defaultNotificationState().telegram.serviceStatus;
  const patchServiceStatus = isObject(patchTelegram.serviceStatus) ? patchTelegram.serviceStatus : {};
  const currentServiceStatusServices = isObject(currentServiceStatus.services) ? currentServiceStatus.services : {};
  const patchServiceStatusServices = isObject(patchServiceStatus.services) ? patchServiceStatus.services : {};
  ...
  return normalizeNotificationState({
    ...
    telegram: {
      ...
      serviceStatus: {
        ...
        ...patchServiceStatus,
        services: {
          ...currentServiceStatusServices,
          ...patchServiceStatusServices,
        },
      },
    },
  });
